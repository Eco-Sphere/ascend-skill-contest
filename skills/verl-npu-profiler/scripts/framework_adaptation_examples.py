#!/usr/bin/env python3
"""
框架适配示例：展示如何在不同框架中集成NPU Profiler
包括：PyTorch原生、verl框架、xtuner框架、自定义框架
"""
...
""".format(
        pytorch_code=adapt_pytorch_native(),
        verl_code=adapt_verl_framework(),
        xtuner_code=adapt_xtuner_framework(),
        custom_code=adapt_custom_framework(),
    )
...
if __name__ == "__main__":
    # 生成适配指南
    guide = create_adaptation_guide()
    
    # 保存到文件
    output_path = Path(__file__).parent.parent / "reference" / "framework_adaptation_guide.md"
    output_path.parent.mkdir(parents=True, exist_ok=True)
    
    with open(output_path, "w", encoding="utf-8") as f:
        f.write(guide)
    
    print(f"适配指南已生成: {output_path}")
    ...
    print("\n【PyTorch原生框架】")
    print("-" * 60)
    print(adapt_pytorch_native()[:500] + "...")
    
    print("\n【verl框架】")
    print("-" * 60)
    print(adapt_verl_framework()[:500] + "...")
    
    print("\n【xtuner框架】")
    print("-" * 60)
    print(adapt_xtuner_framework()[:500] + "...")
    
    print("\n【自定义框架】")
    print("-" * 60)
    print(adapt_custom_framework()[:500] + "...")
