# Qwen3-8B vLLM-Ascend 部署与 AISBench 性能测试 Skill
...
| 作者 | AI Assistant |
| 更新时间 | 2026-03-29 |
| 功能描述 | 在 Atlas 800I A2 NPU 机器上，使用 vllm-ascend 部署 Qwen3-8B 模型，并通过 AISBench 进行性能测试与分析 |

## 2. 使用场景

- 在 Atlas 800I A2 NPU 机器上快速部署 Qwen3-8B 模型服务
- 对部署的模型服务进行自动化性能测试
- 生成可视化的性能分析报告
- 验证模型在 NPU 上的推理性能
...
```
开始执行部署流程...
1. 正在拉取 vllm-ascend 镜像...
2. 正在下载 Qwen3-8B 模型...
3. 正在创建 Docker 容器...
4. 正在启动 vllm-ascend 服务...

✅ 部署完成！服务已在 http://localhost:8000 启动
```
